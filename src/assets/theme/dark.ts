export const dark = {
  ...
  'color-success-focus': '#00B383',
  'color-success-hover': '#51F0B0',
  'color-success-default': '#00E096',
  'color-success-active': '#00B383',
  'color-success-disabled': 'rgba(143, 155, 179, 0.24)',
  'color-success-focus-border': '#008F72',
  'color-success-hover-border': '#51F0B0',
  'color-success-default-border': '#00E096',
  'color-success-active-border': '#00B383',
  ...
  'color-success-transparent-focus-border': '#00E096',
  'color-success-transparent-hover-border': '#00E096',
  'color-success-transparent-default-border': '#00E096',
  'color-success-transparent-active-border': '#00E096',
  ...
  'background-alternative-color-1': '#FFFFFF',
  'background-alternative-color-2': '#F7F9FC',
  'background-alternative-color-3': '#EDF1F7',
  'background-alternative-color-4': '#E4E9F2',
  ...
  'border-alternative-color-2': '#F7F9FC',
  'border-alternative-color-3': '#EDF1F7',
  'border-alternative-color-4': '#E4E9F2',
  'border-alternative-color-5': '#C5CEE0',
  'border-primary-color-1': '#3366FF',
  'border-primary-color-2': '#274BDB',
  'border-primary-color-3': '#1A34B8',
  'border-primary-color-4': '#102694',
  'border-primary-color-5': '#091C7A',
  'border-success-color-1': '#00E096',
  'border-success-color-2': '#00B383',
  'border-success-color-3': '#008F72',
  'border-success-color-4': '#007566',
  'border-success-color-5': '#00524C',
  'border-info-color-1': '#0095FF',
  'border-info-color-2': '#006FD6',
  'border-info-color-3': '#0057C2',
  'border-info-color-4': '#0041A8',
  'border-info-color-5': '#002885',
  'border-warning-color-1': '#FFAA00',
  'border-warning-color-2': '#DB8B00',
  'border-warning-color-3': '#B86E00',
  'border-warning-color-4': '#945400',
  'border-warning-color-5': '#703C00',
  'border-danger-color-1': '#FF3D71',
  'border-danger-color-2': '#DB2C66',
  'border-danger-color-3': '#B81D5B',
  'border-danger-color-4': '#94124E',
  'border-danger-color-5': '#700940',
  'text-basic-color': '#FFFFFF',
  'text-alternate-color': '#1A2138',
  ...
  'text-success-color': '#00E096',
  'text-success-focus-color': '#00B383',
  'text-success-hover-color': '#51F0B0',
  'text-success-active-color': '#00B383',
  'text-success-disabled-color': '#51F0B0',
  ...
  'text-warning-focus-color': '#DB8B00',
